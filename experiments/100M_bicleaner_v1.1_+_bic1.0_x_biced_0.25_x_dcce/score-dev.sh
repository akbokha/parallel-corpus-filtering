...
. ./local-settings.sh
data_dir=../experiments/100M_bicleaner_v1.1_+_bic1.0_x_biced_0.25_x_dcce/data
model_dir=../experiments/100M_bicleaner_v1.1_+_bic1.0_x_biced_0.25_x_dcce/model
