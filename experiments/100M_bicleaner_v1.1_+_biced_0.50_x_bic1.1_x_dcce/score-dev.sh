...
. ./local-settings.sh
data_dir=../experiments/100M_bicleaner_v1.1_+_biced_0.50_x_bic1.1_x_dcce/data
model_dir=../experiments/100M_bicleaner_v1.1_+_biced_0.50_x_bic1.1_x_dcce/model
