...
. ./local-settings.sh
data_dir=../experiments/100M_fasttext_prob_and_new_hardrules_dcce_scoring/data
model_dir=../experiments/100M_fasttext_prob_and_new_hardrules_dcce_scoring/model
