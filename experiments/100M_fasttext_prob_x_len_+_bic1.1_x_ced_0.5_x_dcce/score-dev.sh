...
. ./local-settings.sh
data_dir=../experiments/100M_fasttext_prob_x_len_+_bic1.1_x_ced_0.5_x_dcce/data
model_dir=../experiments/100M_fasttext_prob_x_len_+_bic1.1_x_ced_0.5_x_dcce/model
