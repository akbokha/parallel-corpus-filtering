...
. ./local-settings.sh
data_dir=../experiments/100M_fasttext_prob_x_len_+_bicleaner_dcce_biced_hdiff_w3000/data
model_dir=../experiments/100M_fasttext_prob_x_len_+_bicleaner_dcce_biced_hdiff_w3000/model
