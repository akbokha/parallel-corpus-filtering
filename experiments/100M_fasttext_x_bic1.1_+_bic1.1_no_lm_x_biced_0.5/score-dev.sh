...
. ./local-settings.sh
data_dir=../experiments/100M_fasttext_x_bic1.1_+_bic1.1_no_lm_x_biced_0.5/data
model_dir=../experiments/100M_fasttext_x_bic1.1_+_bic1.1_no_lm_x_biced_0.5/model
