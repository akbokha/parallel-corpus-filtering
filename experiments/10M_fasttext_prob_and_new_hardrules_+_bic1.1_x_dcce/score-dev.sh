...
. ./local-settings.sh
data_dir=../experiments/10M_fasttext_prob_and_new_hardrules_+_bic1.1_x_dcce/data
model_dir=../experiments/10M_fasttext_prob_and_new_hardrules_+_bic1.1_x_dcce/model
