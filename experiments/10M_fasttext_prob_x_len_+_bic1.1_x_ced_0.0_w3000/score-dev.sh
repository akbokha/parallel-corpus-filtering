...
. ./local-settings.sh
data_dir=../experiments/10M_fasttext_prob_x_len_+_bic1.1_x_ced_0.0_w3000/data
model_dir=../experiments/10M_fasttext_prob_x_len_+_bic1.1_x_ced_0.0_w3000/model
