...
. ./local-settings.sh
data_dir=../experiments/10M_fasttext_prob_x_len_+_biced_0.25_x_bic1.1_x_dcce/data
model_dir=../experiments/10M_fasttext_prob_x_len_+_biced_0.25_x_bic1.1_x_dcce/model
